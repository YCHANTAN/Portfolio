...
import { Target, TerminalSquare, Leaf, Dna, Handshake, ShoppingCart } from 'lucide-react';
...
const projects = [
  ...
  },
  {
    id: 5,
    title: "EducAIte App",
    description: "An AI-powered educational platform designed to streamline academic workflows, offering personalized learning assistants and automated resource management for students.",
  ...
  },
  {
    id: 6,
    title: "Pasabuy",
    description: "A community-driven delivery platform. I led the UI/UX design process, focusing on user flow optimization, high-fidelity prototyping, and a minimalist aesthetic for seamless ordering.",
    tech: "UI/UX & Figma",
  ...
  return (
    <section id="projects" className="py-24 px-6 md:px-12 max-w-7xl mx-auto flex flex-col items-center overflow-hidden">
      ...
      <div className="w-full relative mb-12">
        <div 
          ref={scrollRef}
          className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-8 pt-2 scroll-smooth cursor-grab active:cursor-grabbing [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']"
          ...
          onWheel={(e) => {
            if (scrollRef.current) {
              if (e.deltaY !== 0) {
                // Translates vertical wheel scroll to horizontal movement
        ...
        >
          {projects.map((project) => (
            <div 
              key={project.id} 
              // select-none is crucial so you don't highlight text while dragging
              className="w-[85vw] sm:w-[320px] min-h-[360px] shrink-0 snap-start bg-[#080808] border border-white/5 rounded-3xl p-8 flex flex-col transition-all hover:border-white/15 hover:bg-[#0c0c0c] select-none"
            >
              ...
              {/* Bottom Section: Divider line and Pill */}
